...
?>
<fieldset>
    <legend>Entrega Seal Cargo 1 a 1:</legend>
    <form action="" name="frmRegistrarCargo1to1" id="frmRegistrarCargo1to1" onsubmit="envio_general_forms('#frmRegistrarCargo1to1','acdocumentos_registro.php','#divEstadoRegistroCargo','#divEstadoRegistroCargo','RegistrandoCargo...');return false;">
        <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <input type="hidden" name="registronro" value="EntregaSeal1to1">
            <button type="button" class="btn btn-info" onclick="envio_general_forms('#frmRegistrarCargo1to1','acdocumentos_registro.php','#divEstadoRegistroCargo','#divEstadoRegistroCargo','Registrando Cargo...')">Registrar Entrega</button>
        </div>
    </form>
</fieldset>
<div id="divEstadoRegistroCargo"></div>
<fieldset>
    <legend>Registrar Entrega Seal a grupo de documentos:</legend>
        ...
        <div class="row">
            <div class="col"><!--class="col-lg-6"-->
                <div class="input-group">
                    ...
                    <button class="btn btn-info" type="button" onclick="envio_general_forms('#frmBuscarPorFechas','acdomentosentregaseal.php','#divCuerpoPrincipalACliente','#divEstadoRegistroCargo','Buscando...');">Buscar</button>
                  </span>
                </div>
            </div>
        </div>
    ...
    <form action="" name="frmRegistrarCargoEnMasa" id="frmRegistrarCargoEnMasa">
        <div class="input-group">
            ...
            <button class="btn btn-info" type="button" onclick="envio_general_forms('#frmRegistrarCargoEnMasa','acdocumentos_registro.php?registronro=RegistrarEntregaSealEnMasa','#divEstadoRegistroCargo','#divEstadoRegistroCargo','Registrando...');">Registrar Entrega</button>
            <button class="btn btn-success" type="button" onclick="envio_general_forms('#frmRegistrarCargoEnMasa','acdocumentos_registro.php?registronro=RegistrarEntregaSealEnMasa','#divEstadoRegistroCargo','#divEstadoRegistroCargo','Registrando...');">Registrar Entrega y generar guia</button>
        </div>
