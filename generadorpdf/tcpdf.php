...
class TCPDF {
	...
	public function Footer() {
		...
		//Lineas modificadas por renel
		if (empty($this->pagegroups)) {
			$pagenumtxt = "Pagina: ".$w_page.$this->getAliasNumPage().' / '.$this->getAliasNbPages();
		} else {
			$pagenumtxt = "Pagina: ".$w_page.$this->getPageNumGroupAlias().' / '.$this->getPageGroupAlias();
		}
		$this->SetY($cur_y);
		//Print page number
		if ($this->getRTL()) {
